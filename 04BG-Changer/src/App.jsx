...
function App() {
  ...
  return (
    <>
      <div className="w-full h-screen duration-200 border-3 border-solid" style={{backgroundColor : color}} >
        <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
          <div className='flex flex-wrap justify-center gap-4 shadow-lg bg-white px-4 py-2 rounded-3xl'>
